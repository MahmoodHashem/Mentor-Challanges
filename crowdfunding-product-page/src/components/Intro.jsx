    ...
    return (
        <section className="relative bg-white -mt-14 w-full md:w-[40rem] m-auto p-7 rounded-2xl text-center   ">
            ...
            <div className="btns mt-12 w-full flex items-center justify-between">
                ...
                <button className="
                btn relative flex items-center content-between bg-gray-100 w-auto sm:w-44 p-0 sm:p-3 box-border h-12 rounded-full text-dark-gray font-bold">
                   <img src={bookmark} className='sm:absolute static left-0 w-16 sm:w-12' alt="bookmark icon" />
                   <p className='ml-auto hidden sm:block mr-3 text-lg' >Bookmark</p> 
                </button>
