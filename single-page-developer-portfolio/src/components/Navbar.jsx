...
const Navbar = () => {
    return (
        <nav className="font-SpaceGrotesk flex-1 h-full  text-white p-5 pb-0">
            <div className="flex flex-col items-center md:justify-between w-60  md:h-full md:w-auto gap-5 bg-gradientToTop">
                <div className="logo md:absolute  left-0">
                    <h1 className="text-2xl font-bold " >mahmoodhashemi</h1>
                </div>
                <ul className="flex items-center lg:self-end gap-4  ">
                    <li><a
                ...
                <div className="w-full">
                    <img src={profile} alt="mahmood profile" />
                </div>
            </div>
        </nav>
    )
